...
async function suggestConfig() {
  ...
  const result = _.merge({}, news, datause, event, project, programme, literature, 
    help, tool, navigationelement, organisation,
    participant, homepage, call, document, network, article, notification
    );
