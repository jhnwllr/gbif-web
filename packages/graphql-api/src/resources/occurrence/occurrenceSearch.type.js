...
const typeDef = gql`
  ...
  type OccurrenceFacet {
    ...
    hasCoordinate(size: Int, from: Int): [OccurrenceFacetResult_boolean]
    hasGeospatialIssue(size: Int, from: Int): [OccurrenceFacetResult_boolean]
    repatriated(size: Int, from: Int): [OccurrenceFacetResult_boolean]
